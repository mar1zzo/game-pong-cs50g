...
-- the paddle has the ball as a point of orientation for its movement
-- the initial and final values ​​of the MIN and MAX functions are derived from the ends of the paddle
function Paddle:AIcontrolled(ball)
    if ball.dy < 0 then
